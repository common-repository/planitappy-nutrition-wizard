 ...
 * @subpackage Pia_NutritionWizard/admin/partials
 */ 
...
<div class="wrap">
	    ...
	    <img style="display:block; margin-top: 20px;" <?php echo($logo); ?>  ><h1 style="display:block;">PlanItAppy Nutrition Wizard Settings</h1>
	    ...
	    <div id="Instructions" class="tabcontent" style="display: none;">
		        ...
		        <div class="tab" style="margin-top: 20px;">
		            ...
		            <button class="tablinks2" id="nutritionPlansButton" onclick="secondInstructions(event, 'nutritionPlans')">2: Create the questions that you want answered by clients</button>
		        ...
		        <div id="nutritionPlans" class="tabcontent2" style="display: none;">
		
		            <h2 style="margin-top: 20px;"><b>Create your questionnaire/survey</b></h2>
		            <p>Once you have logged in or signed up, you need to create the questions that will appear on your website. <br>To do that, go to "Clients" > "My Questionnaires" in the top menu.</p>
		            
		            <?php echo('<img src="' . $imgFolder . '/pia-create-questionnaire1.png" style="height:500px">'); ?> 
		            <br >
		            <p style="padding-top: 30px; padding-bottom: 30px;">then click on "Create New Questionnaire":</p>
		            <?php echo('<img src="' . $imgFolder . '/pia-create-questionnaire2.png" style="height:500px">'); ?> 
		            
		            <p style="padding-bottom: 100px;">When you have created one or more questions, you will see them listed in the "Test your Store URL" tab.</p>
		        </div>
		        
		        
		        <div id="TestURL" class="tabcontent2" style="display: none;">
			         <p>If you have correctly saved your store URL and created your questionnaire, you will see them appear below.</p>
			         ...
			         <h2>Nutrition Plan Questionnaire/Survey:</h2>
			         <?php  echo (pia_nutrition_wizard_display()); ?>
			    </div>
		
		
		        <div id="shortcode" class="tabcontent2" style="display: none;">
		            <h2><b>The Shortcode:</b></h2>
		            [pia_nutrition_wizard]
		            <h2 style="margin-top: 20px;"><b>Copy the Shortcode:</b></h2>
		            <p>The plugin shortcode is a small line of code that you use to display the Nutrition Wizard. You can place it anywhere on your site - in Posts, Pages, Widgets, even the Footer if you really want! To avoid any errors when pasting it into a Post or Page, make sure to be in the Text editor before pasting it:</p>
